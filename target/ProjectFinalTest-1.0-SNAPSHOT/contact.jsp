		...
		<div class="shop_inner_inf">
			...
			<div class="inner_section_w3ls">
				<div class="col-md-7 contact_grid_right">
					<iframe src="${infor.banDo}" width="800" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
				</div>
				<div class="col-md-5 contact-left">
					...
					<div class="mail-us">
						...
						<div class="col-md-10 col-sm-10 col-xs-10 contact-text">
							<h4>Mail</h4>
							<p><a href="mailto:${infor.email}">${infor.email}</a></p>
						</div>
						<div class="clearfix"></div>
					</div>
					<div class="call">
