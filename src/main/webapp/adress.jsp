					...
					<div class="list_product">
						...
						<div class="content_pro_b">
							<div class="content_pro_b_box">
								<div class="content_pro_b_left">
									<div class="elem">
										<div class="elem_1">
											<h3  class="dc">Địa Chỉ</h3>
										</div>
										<div class="elem_2 ">
											<h3 id="upadd">${sessionScope.auth.diaChi}</h3>
										</div>
									</div>


								</div>
								<div class="content_pro_b_right">
									<div class="the1">
										<ul>
											<li><button type="button" class="editadd" data-toggle="modal" data-target="#exampleModalCenter">
												Sửa
											</button></li>
										</ul>
									</div>
    		...
    		<div class="modal-content">
      			<div class="modal-header">
					...
					<div class="modal-footer">
						<button type="button" class="editadd" data-dismiss="modal">Đóng</button>
