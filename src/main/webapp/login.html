...
<body>
	...
	<div>
		<div class="form">
			<div class="formdn">
				<h1>Đăng Nhập</h1>
				<label class="l1" for="email">Tên tài khoản</label>
				<input type="text">
				...
				<hr>
				<ul>
					<li><a href=""><img src="images/google_logo.jpg"></a></li>
					<li><a href=""><img src="images/facelogo.jpg"></a></li>
				</ul>
				<a class="qmk" href="forgetpass.html">Quên mật khẩu?</a>
			</div>
			<div class="formdk">
				<h1>Đăng Ký</h1>
				<label class="l1" for="">Tên tài khoản</label>
