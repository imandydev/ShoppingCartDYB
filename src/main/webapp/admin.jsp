				  	...
				  	<div class="content">
										...
										<div class="left">
											<div class="row1">
												...
												<input class="id-order-show" type="text" value="12312312" readonly>
											</div>
											<div class="row2">
												<label >Mã Khách Hàng (ID)</label><br>
												<input class="id-user-show" type="text" value="1" readonly>
											</div>
											<div class="row3">
												<label >Số Lượng Sản Phẩm</label><br>
												<input class="sum-amount-show" type="text" value="3" readonly>
											</div>
											<div class="row4">
												<label >Ngày Đặt</label><br>
												<input class="date-order-show" type="text" value="12/11/2020" readonly>
											</div>
											<div class="row2">
				...
				<div class="center" style="max-height: 500px;">
					<table class="table table-bordered" >
						...
						<tr>
							...
							<td><input class="total-pricePro-show" type="text" value="" readonly></td>
