...
@WebServlet(name = "HDMuaHang", urlPatterns = "/hdmuahang")
public class HDMuaHang extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("hdmuahang.jsp").forward(request, response);
    }
}